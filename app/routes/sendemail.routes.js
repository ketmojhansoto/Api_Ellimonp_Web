...
router.post("/", (req, res) => {
  ...
  async function sendMail(user, callback) {
    ...
    let mailOptions = {
        ...
        subject: "😃🍴Reserva Completada Exitosamente 🍴😃", // Subject line
        html: `
        <div style="text-align: center"><img style="width: 200px" src="https://limonpimg.s3.us-east-2.amazonaws.com/img_web/logo.png"></div>
        <h1 style="text-align: center">🍋🐟 Su reserva a sido concretada 🐟🍋</h1>
        <p>Hola ${user.name}</p>
        <p>
            ¡Gracias por tu pedido! <br>
            En estos momentos tu reserva se a completado, gracias por elegir la reserva con nosotros "El Limoncito Peruano".<br>
        ...
        <tr>
            <td>
            <strong>Fecha de la Reserva</strong:>&nbsp; ${user.fecha} <br>
            <strong>Hora de la Reserva:</strong>&nbsp;${user.hora}
            </td>
            <td>
